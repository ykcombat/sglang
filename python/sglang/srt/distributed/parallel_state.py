...
def get_tp_group() -> GroupCoordinator:
    if _ENABLE_PDMUX_P_TP:
        assert _PDMUX_P_TP is not None, "tensor model parallel group for PD-Multiplexing Prefill is not initialized"
        return _PDMUX_P_TP       
...
def initialize_model_parallel(
    ...
    if duplicate_tp_group:
        global _PDMUX_P_TP
        assert _PDMUX_P_TP is None, "tensor model parallel group for PD-Multiplexing Prefill is already initialized"   
